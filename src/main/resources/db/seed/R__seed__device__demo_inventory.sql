...
--
-- Edit THIS file when the default device inventory changes. Repeatable
-- migration (R__): re-runs whenever the checksum changes. ON CONFLICT DO
-- NOTHING keeps re-runs safe.
--
