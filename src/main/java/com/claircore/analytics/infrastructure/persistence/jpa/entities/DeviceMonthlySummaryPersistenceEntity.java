...
/** Storage shape of {@code DeviceMonthlySummary}. */
@Entity
@Table(name = "device_monthly_summaries",
        uniqueConstraints = @UniqueConstraint(columnNames = {"device_id", "summary_month"}))
public class DeviceMonthlySummaryPersistenceEntity extends AuditableAbstractPersistenceEntity {
    ...
    public DeviceMonthlySummaryPersistenceEntity() {
    ...
    public void setDaysCovered(int daysCovered) { this.daysCovered = daysCovered; }
}
