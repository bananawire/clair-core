-- =============================================================================
-- Analytics bounded context — canonical schema (repeatable migration).
--
-- This is THE file to edit when the Analytics schema changes. V1..V6 already
...
CREATE TABLE IF NOT EXISTS device_daily_summaries (
    id                       uuid                        NOT NULL,
    device_id                uuid                        NOT NULL,
...
CREATE TABLE IF NOT EXISTS device_monthly_summaries (
    id                       uuid                        NOT NULL,
    device_id                uuid                        NOT NULL,
